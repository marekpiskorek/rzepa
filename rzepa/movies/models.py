...
class Movie(models.Model):
    ...
    box_office = models.CharField(max_length=128, blank=True, default="")
    country = models.CharField(max_length=128, blank=True, default="")
    dvd = models.CharField(max_length=128, blank=True, default="")
    director = models.CharField(max_length=128, blank=True, default="")
    ...
    production = models.CharField(max_length=128, blank=True, default="")
    rated = models.CharField(max_length=16, blank=True, default="")
    released = models.CharField(max_length=128, blank=True, default="")
    ...
    writer = models.CharField(max_length=128, blank=True, default="")
